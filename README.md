...
- Visual Studio 2022使用文件比较工具：在Windows系统的“开始菜单”中找到“Visual Studio 2022”文件夹，点击“x64 Native Tools Command Prompt for VS 2022”，进入后可直接输入：**`devenv /diff file1.cs file2.cs`**。如果是用Visual Studio Code，可在命令行用：**`code.exe --diff file1.cs file2.cs`**。
